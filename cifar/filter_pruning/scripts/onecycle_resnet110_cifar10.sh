...
# finetune 1
python finetune.py  --refine checkpoints/pruned/cifar10/resnet110/prune_1/pruned.pth.tar \
--dataset cifar10 \
--arch resnet110 \
--save checkpoints/pruned/cifar10/resnet110/prune_1 &&
# prune 2
...
python residualprune.py --dataset cifar10 \
--arch resnet110 \
--model checkpoints/pruned/cifar10/resnet110/prune_1/checkpoint.pth.tar \
--save checkpoints/pruned/cifar10/resnet110/prune_2 &&
# finetune 2
python finetune.py  --refine checkpoints/pruned/cifar10/resnet110/prune_2/pruned.pth.tar \
--dataset cifar10 \
--arch resnet110 \
--save checkpoints/pruned/cifar10/resnet110/prune_2 &&
# prune 3
...
python residualprune.py --dataset cifar10 \
--arch resnet110 \
--model checkpoints/pruned/cifar10/resnet110/prune_2/checkpoint.pth.tar \
--save checkpoints/pruned/cifar10/resnet110/prune_3 &&
# finetune 3
python finetune.py  --refine checkpoints/pruned/cifar10/resnet110/prune_3/pruned.pth.tar \
--dataset cifar10 \
--arch resnet110 \
--save checkpoints/pruned/cifar10/resnet110/prune_3 &&
# prune 4
...
python residualprune.py --dataset cifar10 \
--arch resnet110 \
--model checkpoints/pruned/cifar10/resnet110/prune_3/checkpoint.pth.tar \
--save checkpoints/pruned/cifar10/resnet110/prune_4 &&
# finetune 4
python finetune.py  --refine checkpoints/pruned/cifar10/resnet110/prune_4/pruned.pth.tar \
--dataset cifar10 \
--arch resnet110 \
--save checkpoints/pruned/cifar10/resnet110/prune_4 &&
# prune 5
...
python residualprune.py --dataset cifar10 \
--arch resnet110 \
--model checkpoints/pruned/cifar10/resnet110/prune_4/checkpoint.pth.tar \
--save checkpoints/pruned/cifar10/resnet110/prune_5 &&
# finetune 5
python finetune.py  --refine checkpoints/pruned/cifar10/resnet110/prune_5/pruned.pth.tar \
--dataset cifar10 \
--arch resnet110 \
--save checkpoints/pruned/cifar10/resnet110/prune_5 &&
# ensemble finetune
