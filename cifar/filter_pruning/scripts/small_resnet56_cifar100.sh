...
--arch resnet56 \
--model checkpoints/cifar100/resnet-56/model_best.pth.tar \
--save prune_1 &&
...
--dataset cifar100 --save snapshot_ensemble --arch resnet56 \
--teachers 'checkpoints/cifar100/resnet-56/model_best.pth.tar' \
