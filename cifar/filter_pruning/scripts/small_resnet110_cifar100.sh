...
--schedule 50 \
--refine checkpoints/pruned/cifar100/resnet110/prune_1/pruned.pth.tar \
--dataset cifar100 \
--arch resnet110 \
--no-onecycle \
--save checkpoints/pruned/cifar100/resnet110/prune_1 &&
...
python finetune.py --lr 0.001 \
--schedule 50 \
--refine checkpoints/pruned/cifar100/resnet110/prune_2/pruned.pth.tar \
--dataset cifar100 \
--arch resnet110 \
--no-onecycle \
--save checkpoints/pruned/cifar100/resnet110/prune_2 &&
...
python finetune.py --lr 0.001 \
--schedule 50 \
--refine checkpoints/pruned/cifar100/resnet110/prune_3/pruned.pth.tar \
--dataset cifar100 \
--arch resnet110 \
--no-onecycle \
--save checkpoints/pruned/cifar100/resnet110/prune_3 &&
...
python finetune.py --lr 0.001 \
--schedule 50 \
--refine checkpoints/pruned/cifar100/resnet110/prune_4/pruned.pth.tar \
--dataset cifar100 \
--arch resnet110 \
--no-onecycle \
--save checkpoints/pruned/cifar100/resnet110/prune_4 &&
...
python finetune.py --lr 0.001 \
--schedule 50 \
--refine checkpoints/pruned/cifar100/resnet110/prune_5/pruned.pth.tar \
--dataset cifar100 \
--arch resnet110 \
--no-onecycle \
--save checkpoints/pruned/cifar100/resnet110/prune_5 &&
