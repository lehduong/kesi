...
# finetune 1
python finetune.py  --refine checkpoints/pruned/cifar100/resnet56/prune_1/pruned.pth.tar \
--dataset cifar100 \
--arch resnet56 \
--save checkpoints/pruned/cifar100/resnet56/prune_1 &&
# prune 2
...
# finetune 2
python finetune.py  --refine checkpoints/pruned/cifar100/resnet56/prune_2/pruned.pth.tar \
--dataset cifar100 \
--arch resnet56 \
--save checkpoints/pruned/cifar100/resnet56/prune_2 &&
# prune 3
...
# finetune 3
python finetune.py  --refine checkpoints/pruned/cifar100/resnet56/prune_3/pruned.pth.tar \
--dataset cifar100 \
--arch resnet56 \
--save checkpoints/pruned/cifar100/resnet56/prune_3 &&
# prune 4
...
# finetune 4
python finetune.py  --refine checkpoints/pruned/cifar100/resnet56/prune_4/pruned.pth.tar \
--dataset cifar100 \
--arch resnet56 \
--save checkpoints/pruned/cifar100/resnet56/prune_4 &&
# prune 5
...
# finetune 5
python finetune.py  --refine checkpoints/pruned/cifar100/resnet56/prune_5/pruned.pth.tar \
--dataset cifar100 \
--arch resnet56 \
--save checkpoints/pruned/cifar100/resnet56/prune_5 &&
# ensemble finetune
