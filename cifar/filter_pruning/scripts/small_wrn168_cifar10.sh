...
--schedule 50\
--refine checkpoints/pruned/cifar10/wrn_16_8/prune_1/pruned.pth.tar \
--dataset cifar10 \
--arch wrn_16_8 \
--no-onecycle \
--save checkpoints/pruned/cifar10/wrn_16_8/prune_1 &&
...
python finetune.py --lr 0.001 \
--schedule 50\
--refine checkpoints/pruned/cifar10/wrn_16_8/prune_2/pruned.pth.tar \
--dataset cifar10 \
--arch wrn_16_8 \
--no-onecycle \
--save checkpoints/pruned/cifar10/wrn_16_8/prune_2 &&
...
python finetune.py --lr 0.001 \
--schedule 50\
--refine checkpoints/pruned/cifar10/wrn_16_8/prune_3/pruned.pth.tar \
--dataset cifar10 \
--arch wrn_16_8 \
--no-onecycle \
--save checkpoints/pruned/cifar10/wrn_16_8/prune_3 &&
...
python finetune.py --lr 0.001 \
--schedule 50\
--refine checkpoints/pruned/cifar10/wrn_16_8/prune_4/pruned.pth.tar \
--dataset cifar10 \
--arch wrn_16_8 \
--no-onecycle \
--save checkpoints/pruned/cifar10/wrn_16_8/prune_4 &&
...
python finetune.py --lr 0.001 \
--schedule 50\
--refine checkpoints/pruned/cifar10/wrn_16_8/prune_5/pruned.pth.tar \
--dataset cifar10 \
--arch wrn_16_8 \
--no-onecycle \
--save checkpoints/pruned/cifar10/wrn_16_8/prune_5 &&
