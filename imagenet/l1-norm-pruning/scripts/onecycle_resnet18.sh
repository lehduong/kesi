...
python residualprune.py /content/tiny-imagenet-200 \
                        ...
                        --num_classes 200 &&
python main_finetune.py /content/tiny-imagenet-200 \
                        --save prune_5 --arch resnet18 --lr 0.1 --num_classes 200 -b 128 --refine \
                        prune_5/pruned.pth.tar --print-freq 100 --schedule 8 15 20 --epochs 25 &&
...
python ensemble_finetune.py /content/tiny-imagenet-200 \
                        ...
                        prune_5/checkpoint.pth.tar --print-freq 100 --schedule 8 15 20 --epochs 25