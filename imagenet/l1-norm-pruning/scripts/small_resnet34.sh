...
echo "PRUNE: 2" &&
python residualprune.py /content/tiny-imagenet-200 \
                        --save prune_2 --arch resnet34 --test-batch-size 128 \
                        --model prune_1/checkpoint.pth.tar \
                        --num_classes 200 &&
python main_finetune.py /content/tiny-imagenet-200 \
                        --save prune_2 --arch resnet34 --lr 0.001 --no-onecycle --num_classes 200 -b 128 --refine \
                        prune_2/pruned.pth.tar --print-freq 100 --schedule 50 --epochs 25 &&
echo "PRUNE: 3" &&
python residualprune.py /content/tiny-imagenet-200 \
                        --save prune_3 --arch resnet34 --test-batch-size 128 \
                        --model prune_2/checkpoint.pth.tar \
                        --num_classes 200 &&
python main_finetune.py /content/tiny-imagenet-200 \
                        --save prune_3 --arch resnet34 --lr 0.001 --no-onecycle --num_classes 200 -b 128 --refine \
                        prune_3/pruned.pth.tar --print-freq 100 --schedule 50 --epochs 25 &&
echo "PRUNE: 4" &&
python residualprune.py /content/tiny-imagenet-200 \
                        --save prune_4 --arch resnet34 --test-batch-size 128 \
                        --model prune_3/checkpoint.pth.tar \
                        --num_classes 200 &&
python main_finetune.py /content/tiny-imagenet-200 \
                        --save prune_4 --arch resnet34 --lr 0.001 --no-onecycle --num_classes 200 -b 128 --refine \
                        prune_4/pruned.pth.tar --print-freq 100 --schedule 50 --epochs 25 &&
echo "PRUNE: 5" &&
python residualprune.py /content/tiny-imagenet-200 \
                        --save prune_5 --arch resnet34 --test-batch-size 128 \
                        --model prune_4/checkpoint.pth.tar \
                        --num_classes 200 &&
python main_finetune.py /content/tiny-imagenet-200 \
                        --save prune_5 --arch resnet34 --lr 0.001 --no-onecycle --num_classes 200 -b 128 --refine \
...
python ensemble_finetune.py /content/tiny-imagenet-200 \
                        --save kd --arch resnet34 --lr 0.001 --num_classes 200 -b 128 --refine \
